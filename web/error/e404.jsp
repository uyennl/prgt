<%-- 
    Document   : e404.jsp
    Created on : Jan 16, 2024, 4:52:23 PM
    Author     : PC
--%>
...
<!--                <link href="http://localhost:8080/BaiTap12_BatLoiTrang_titv/css/error404.css" rel=”stylesheet” type="text/css" />-->
...
<!--        <% String path = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath(); %>
        <img class="img" src="<%=path%>/img/404.jpg" alt="Error 404"/>-->
